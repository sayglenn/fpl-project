    ...
    <>
      <div className="flex flex-col items-center">
        <div className="flex flex-col items-center mt-6 border-b-2 border-gray-300 pb-3 lg:w-[540px]">
          ...
          >
            Want to take a look at how your team fared compared to the rest of
            the league? You&apos;re in the right place! Enjoy a short overview
            of the gameweek as well with a recap of the exciting fixtures and
            potential downfalls in the upcoming week.
          </p>
        </div>
        <div className="p-3">
